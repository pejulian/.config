return {
    ...
    config = function()
        ...
        wk.add({
            ...
            { "<leader>lsj", "<cmd>Lspsaga diagnostic_jump_next<cr>", desc = "Jump to next diagnostic" },
            { "<leader>lsk", "<cmd>Lspsaga diagnostic_jump_prev<cr>", desc = "Jump to previous diagnostic" },
        })
    end,
}
